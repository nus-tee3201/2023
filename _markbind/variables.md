...
<variable name="luminus_module_id">tbd</variable>
<variable name="url_instructors">n/a</variable>

<variable name="url_coursemology_classroom">tbd</variable>
<variable name="url_ms_teams_class">tbd</variable>

<variable name="date_w1_start">2022-01-09</variable>
